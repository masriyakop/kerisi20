...
Kerisi Database schema:

model account_main {
  acm_acct_code           String                    @id @db.VarChar(10)
  acm_acct_desc           String?                   @db.VarChar(500)
  acm_acct_desc_eng       String?                   @db.VarChar(250)
  acm_acct_activity       String?                   @db.VarChar(20)
  acm_acct_type           String?                   @db.VarChar(50)
  acm_acct_level          Decimal?                  @db.Decimal(8, 0)
  acm_acct_parent         String?                   @db.VarChar(10)
  acm_acct_status         String?                   @db.VarChar(10)
  acm_acct_group          String?                   @db.VarChar(100)
  acm_flag_budget         String?                   @db.VarChar(1)
  acm_behavior            String?                   @db.VarChar(45)
  acm_flag_pettycash      String?                   @db.VarChar(1)
  acm_flag_research       String?                   @db.VarChar(1)
  acm_flag_event          String?                   @db.VarChar(1)
  acm_flag_project        String?                   @db.VarChar(1)
  acm_flag_studactvty     String?                   @db.VarChar(1)
  acm_flag_erasmi         String?                   @db.VarChar(1)
  acm_flag_procurement    String?                   @db.VarChar(1)
  acm_flag_advance        String?                   @db.VarChar(1)
  acm_flag_subsidiary     String?                   @db.VarChar(1)
  acm_extended_field      Json?
  createddate             DateTime?                 @default(now()) @db.DateTime(0)
  createdby               String?                   @db.VarChar(250)
  updateddate             DateTime?                 @db.DateTime(0)
  updatedby               String?                   @db.VarChar(250)
  acm_flag_cashbook       String?                   @db.VarChar(1)
  acm_flag_deposit        String?                   @db.VarChar(1)
  acm_flag_stud_debt      String?                   @db.VarChar(1)
  acm_flag_boc_debt       String?                   @db.VarChar(1)
  acm_flag_oth_debt       String?                   @db.VarChar(1)
  acm_flag_donation       String?                   @db.VarChar(1)
  acm_flag_myfislite      String?                   @db.VarChar(1)
  acm_flag_money_transfer String?                   @db.VarChar(1)
  ...
  @@index([acm_acct_parent], map: "ind_account_main_01")
}
...
model activity_type {
  ...
  activity_group_code        String?               @db.VarChar(10)
  activity_subgroup_code     String?               @db.VarChar(10)
  activity_subsiri_code      String?               @db.VarChar(10)
  at_is_openpayment          String?               @db.VarChar(1)
  at_status                  String?               @db.VarChar(10)
  at_source                  String?               @db.VarChar(50)
  at_extended_field          Json?
  createddate                DateTime?             @default(now()) @db.DateTime(0)
  createdby                  String?               @db.VarChar(250)
  updateddate                DateTime?             @db.DateTime(0)
  updatedby                  String?               @db.VarChar(250)
...
model costcentre {
  ...
  ccr_extended_field      Json?
  createddate             DateTime?             @default(now()) @db.DateTime(0)
  createdby               String?               @db.VarChar(250)
  updateddate             DateTime?             @db.DateTime(0)
  updatedby               String?               @db.VarChar(250)
  ccr_group_hostel_code   String?               @db.VarChar(20)
  ccr_flag_salary         String?               @db.VarChar(1)
  capital_project         capital_project[]
  org_unit_costcentre     org_unit_costcentre[]
  posting_details         posting_details[]
}
...
model fund_type {
  ...
  fty_remark              String?               @db.VarChar(250)
  fty_extended_field      Json?
  createddate             DateTime?             @default(now()) @db.DateTime(0)
  createdby               String?               @db.VarChar(250)
  updateddate             DateTime?             @db.DateTime(0)
  updatedby               String?               @db.VarChar(250)
  fty_flag_amortization   String?               @db.VarChar(1)
  fty_flag_budget_closing String?               @db.VarChar(1)
  fty_prefix              String?               @db.VarChar(1)
  fty_equity_code         String?               @db.VarChar(50)
  fty_equity_code_rizab   String?               @db.VarChar(50)
  fty_isDefaultFund       String?               @db.VarChar(1)
  capital_project         capital_project[]
  org_unit_costcentre     org_unit_costcentre[]
  posting_details         posting_details[]
  structure_budget        structure_budget[]
...
model quarter_budget {
  ...
  @@unique([qbu_year, qbu_start_date, qbu_end_date], map: "quarter_budget_uq01")
}
...
model structure_budget {
  ...
  cpa_project_no_old                                                             String?                @db.VarChar(30)
  lbc_budget_code_old                                                            String?                @db.VarChar(10)
  sbg_budget_id_new                                                              Int?
  budget                                                                         budget[]
  budget_movement_detl_budget_movement_detl_sbg_budget_id_fromTostructure_budget budget_movement_detl[] @relation("budget_movement_detl_sbg_budget_id_fromTostructure_budget")
  budget_movement_detl_budget_movement_detl_sbg_budget_id_toTostructure_budget   budget_movement_detl[] @relation("budget_movement_detl_sbg_budget_id_toTostructure_budget")
  budget_transaction                                                             budget_transaction[]
  organization_unit                                                              organization_unit?     @relation(fields: [oun_code], references: [oun_code], onDelete: NoAction, onUpdate: NoAction, map: "structure_budget_fk01")
  fund_type                                                                      fund_type?             @relation(fields: [fty_fund_type], references: [fty_fund_type], onDelete: Restrict, onUpdate: Restrict, map: "structure_budget_fk02")
  activity_type                                                                  activity_type?         @relation(fields: [at_activity_code], references: [at_activity_code], onDelete: Restrict, onUpdate: Restrict, map: "structure_budget_fk03")
  lkp_budget_code                                                                lkp_budget_code?       @relation(fields: [lbc_budget_code], references: [lbc_budget_code], onDelete: Restrict, onUpdate: Restrict, map: "structure_budget_fk05")

  @@unique([fty_fund_type, oun_code, ccr_costcentre, at_activity_code, lbc_budget_code, sby_year], map: "sbg_uq1")
  @@index([oun_code], map: "structure_budget_fk01")
  @@index([fty_fund_type], map: "structure_budget_fk02")
  @@index([at_activity_code], map: "structure_budget_fk03")
  @@index([lbc_budget_code], map: "structure_budget_fk05")
  @@index([cpa_project_no], map: "structure_budget_fk06")
}
...
model lkp_budget_code {
  ...
  lbc_extended_field  Json?
  lbc_status          String             @db.VarChar(20)
  createddate         DateTime?          @default(now()) @db.DateTime(0)
  createdby           String?            @db.VarChar(250)
  updateddate         DateTime?          @db.DateTime(0)
  updatedby           String?            @db.VarChar(250)
  lbc_budget_code_old String?            @db.VarChar(45)
  structure_budget    structure_budget[]
}
...
model budget_movement_detl {
  bmd_bgt_movement_detl_id                                                   Int                    @id
  bmm_budget_movement_id                                                     Int
  sbg_budget_id_from                                                         Int?
  sbg_budget_id_to                                                           Int?
  qbu_quarter_id                                                             Int?
  bmd_mvt_amt                                                                Decimal?               @db.Decimal(15, 2)
  bmd_mvt_status                                                             String?                @db.VarChar(10)
  bmd_reason                                                                 String?                @db.VarChar(250)
  bmd_currency_amt                                                           Decimal?               @db.Decimal(15, 4)
  cym_currency_code                                                          String?                @db.VarChar(10)
  cyd_unit                                                                   String?                @db.VarChar(10)
  cyd_conversation_rate                                                      String?                @db.VarChar(10)
  bmd_extended_field                                                         Json?
  createddate                                                                DateTime?              @default(now()) @db.DateTime(0)
  createdby                                                                  String?                @db.VarChar(250)
  updateddate                                                                DateTime?              @db.DateTime(0)
  updatedby                                                                  String?                @db.VarChar(250)
  structure_budget_budget_movement_detl_sbg_budget_id_fromTostructure_budget structure_budget?      @relation("budget_movement_detl_sbg_budget_id_fromTostructure_budget", fields: [sbg_budget_id_from], references: [sbg_budget_id], onDelete: Restrict, onUpdate: Restrict, map: "budget_movement_detl_fk01")
  structure_budget_budget_movement_detl_sbg_budget_id_toTostructure_budget   structure_budget?      @relation("budget_movement_detl_sbg_budget_id_toTostructure_budget", fields: [sbg_budget_id_to], references: [sbg_budget_id], onDelete: Restrict, onUpdate: Restrict, map: "budget_movement_detl_fk02")
  budget_movement_master                                                     budget_movement_master @relation(fields: [bmm_budget_movement_id], references: [bmm_budget_movement_id], onDelete: NoAction, onUpdate: NoAction, map: "fk_reference_64")

  @@index([sbg_budget_id_from], map: "budget_movement_detl_fk01")
  @@index([sbg_budget_id_to], map: "budget_movement_detl_fk02")
  @@index([bmm_budget_movement_id], map: "fk_reference_64")
}


model budget_movement_master {
  bmm_budget_movement_id Int                    @id
  bmm_budget_movement_no String?                @db.VarChar(30)
  bmm_year               String?                @db.VarChar(4)
  qbu_quarter_id         Int?
  bmm_trans_type         String?                @db.VarChar(10)
  bmm_movement_type      String?                @db.VarChar(10)
  bmm_total_amt          Decimal?               @db.Decimal(15, 2)
  bmm_status             String?                @db.VarChar(10)
  bmm_approve_by         String?                @db.VarChar(10)
  bmm_approve_date       DateTime?              @db.DateTime(0)
  bmm_cancel_by          String?                @db.VarChar(10)
  bmm_cancel_date        DateTime?              @db.DateTime(0)
  bmm_reason             String?                @db.VarChar(200)
  bmm_remark             String?                @db.VarChar(100)
  org_code               String?                @db.VarChar(20)
  bmm_extended_field     Json?
  createddate            DateTime?              @default(now()) @db.DateTime(0)
  createdby              String?                @db.VarChar(250)
  updateddate            DateTime?              @db.DateTime(0)
  updatedby              String?                @db.VarChar(250)
  bmm_endorse_doc        String?                @db.VarChar(100)
  bmm_cancel_remark      String?                @db.VarChar(100)
  bmm_fileid             String?                @db.VarChar(45)
  bmm_description        String?                @db.VarChar(1000)
  bmm_money_transfer     String?                @db.VarChar(1)
  budget_movement_detl   budget_movement_detl[]
  quarter_budget         quarter_budget?        @relation(fields: [qbu_quarter_id], references: [qbu_quarter_id], onDelete: Restrict, onUpdate: Restrict, map: "budget_movement_detl_fk03")

  @@index([qbu_quarter_id], map: "budget_movement_detl_fk03")
  @@index([bmm_budget_movement_no, bmm_trans_type], map: "ind_movement_no")
}
...
model budget_allocation_detl {
  bad_detl_id              Int                       @id
  bad_master_id            Int?
  bad_sbg_id               Int?
  oun_code                 String?                   @db.VarChar(45)
  fty_fund_type            String?                   @db.VarChar(45)
  at_activity_code         String?                   @db.VarChar(45)
  ccr_costcentre           String?                   @db.VarChar(45)
  cpa_project_no           String?                   @db.VarChar(45)
  budget_code              String?                   @db.VarChar(45)
  initial_amt              Decimal?                  @db.Decimal(15, 2)
  bdg_budget_id            Int?
  bad_extended_field       Json?
  bad_status               String?                   @db.VarChar(45)
  createddate              DateTime?                 @default(now()) @db.DateTime(0)
  createdby                String?                   @db.VarChar(45)
  updateddate              DateTime?                 @db.DateTime(0)
  updatedby                String?                   @db.VarChar(45)
  cascading_old            String?                   @db.VarChar(45)
  cpa_project_no_old       String?                   @db.VarChar(45)
  budget_code_old          String?                   @db.VarChar(45)
  budget_allocation_master budget_allocation_master? @relation(fields: [bad_master_id], references: [bam_id], onDelete: Cascade, map: "FK_budget_allocarion_02")

  @@index([bad_master_id], map: "FK_budget_allocarion_01_idx")
}

model budget_allocation_master {
  bam_id                 Int                      @id
  bam_allocation_no      String?                  @unique(map: "bam_allocation_no") @db.VarChar(30)
  bam_year               String?                  @db.VarChar(45)
  bam_quarter_id         String?                  @db.VarChar(45)
  bam_endorse_doc        String?                  @db.VarChar(1000)
  bam_file_name          String?                  @db.VarChar(250)
  bam_total              Decimal?                 @db.Decimal(15, 2)
  bam_status_cd          String?                  @db.VarChar(45)
  bam_extended_field     String?                  @db.VarChar(45)
  createddate            DateTime?                @default(now()) @db.DateTime(0)
  createdby              String?                  @db.VarChar(45)
  updateddate            DateTime?                @db.DateTime(0)
  updatedby              String?                  @db.VarChar(45)
  bam_cancel_remark      String?                  @db.VarChar(100)
...
model organization_authorization {
  ora_id                 Int       @id @default(autoincrement())
  ora_staff_id           String    @db.VarChar(45)
  ora_item_type          String?   @db.VarChar(45)
  ora_item_code          String?   @db.VarChar(45)
  ora_is_hod             Int?      @default(0)
  ora_cascade_role       String?   @db.VarChar(45)
  ora_cascade_ptj        String?   @db.VarChar(45)
  ora_cascade_costcentre String?   @db.VarChar(45)
  ora_cascade_fund       String?   @db.VarChar(45)
  ora_cascade_activity   String?   @db.VarChar(45)
  ora_date_from          DateTime? @db.DateTime(0)
  ora_date_to            DateTime? @db.DateTime(0)
  CREATEDBY              String?   @db.VarChar(45)
  CREATEDDATE            DateTime? @default(now()) @db.DateTime(0)
  UPDATEDBY              String?   @db.VarChar(45)
...
model service_scheme {
  ssc_service_code        String    @id @db.VarChar(10)
  ssc_service_desc        String?   @db.VarChar(100)
  ssc_service_group       String?   @db.VarChar(10)
  ssc_class_code          String?   @db.VarChar(10)
  ssc_service_type        String?   @db.VarChar(20)
  ssc_service_field       String?   @db.VarChar(10)
  ssc_recommender_status  String?   @db.VarChar(1)
  sr_salary_grade         String?   @db.VarChar(20)
  sgs_scheme              String?   @db.VarChar(10)
  ssc_allow_category      String?   @db.VarChar(10)
  ssc_service_kumpp       String?   @db.VarChar(10)
  ssc_academic            String?   @db.VarChar(1)
  ssc_desc_short          String?   @db.VarChar(50)
  ssc_scheme_code         String?   @db.VarChar(10)
  ssc_job_code            String?   @db.VarChar(10)
  ssc_salary_code         String?   @db.VarChar(10)
  ssc_status              String?   @db.VarChar(10)
  ssc_rank_kumpp          Decimal?  @db.Decimal(10, 2)
  ssc_critical_service    String?   @db.VarChar(1)
  ssc_service_eng         String?   @db.VarChar(100)
  ssc_position_group_kpt  String?   @db.VarChar(10)
  ssc_position_group_desc String?   @db.VarChar(30)
  ssc_option              String?   @db.VarChar(10)
  ssc_qualification       String?   @db.VarChar(1)
  ssc_extended_field      Json?
  createddate             DateTime? @default(now()) @db.DateTime(0)
  createdby               String?   @db.VarChar(250)
  updateddate             DateTime? @db.DateTime(0)
  updatedby               String?   @db.VarChar(250)
  ssc_flag_ot_without_tnc String?   @db.VarChar(1)
  ssc_flag_ot_limit       String?   @db.VarChar(1)
}
...
model ccontroller_bank_guarantee {
  cbg_id                 Int       @id
  vcs_vendor_code        String?   @db.VarChar(20)
  cbg_issuer_bank        String    @db.VarChar(10)
  cbg_branch_name        String    @db.VarChar(100)
  cbg_bog_no             String?   @db.VarChar(50)
  cbg_bog_date           DateTime? @db.Date
  cbg_bog_expired        DateTime? @db.Date
  cbg_agreement_no       String?   @db.VarChar(100)
  cbg_agreement_end_date DateTime? @db.DateTime(0)
  cbg_amount             Decimal?  @db.Decimal(15, 2)
  cbg_po_no              String?   @db.VarChar(20)
  cbg_po_date            DateTime? @db.Date
  cbg_release_no         String?   @db.VarChar(20)
  cbg_release_date       DateTime? @db.Date
  cbg_status             String?   @db.VarChar(10)
  cbg_remark             String?   @db.VarChar(200)
  cbg_extended_field     Json?
  createddate            DateTime? @default(now()) @db.DateTime(0)
  createdby              String?   @db.VarChar(250)
  updateddate            DateTime? @db.DateTime(0)
  updatedby              String?   @db.VarChar(250)
...
model credit_note_ap_details {
  crd_id                       Int                    @id @default(autoincrement())
  cna_credit_note_ap_master_id Int?
  bid_bills_details_id         Int?
  crd_line_no                  Int
  itm_item_code                String?                @db.VarChar(100)
  itm_item_desc                String?                @db.VarChar(200)
  pom_order_no                 String?                @db.VarChar(30)
  ...
  oun_code                     String?                @db.VarChar(20)
  bid_amt                      Decimal?               @db.Decimal(15, 2)
  crd_cn_amt                   Decimal?               @db.Decimal(15, 2)
  crd_bal_amt                  Decimal?               @db.Decimal(15, 2)
  bid_ent_amt                  Decimal?               @db.Decimal(15, 4)
  crd_cn_ent_amt               Decimal?               @db.Decimal(15, 4)
  crd_bal_ent_amt              Decimal?               @db.Decimal(15, 4)
  crd_transaction_type         String?                @db.VarChar(20)
  crd_status                   String?                @db.VarChar(30)
  acm_acct_code                String?                @db.VarChar(10)
  fty_fund_type                String?                @db.VarChar(20)
  at_activity_code             String?                @db.VarChar(20)
  ccr_costcentre               String?                @db.VarChar(20)
  so_code                      String?                @db.VarChar(45)
  bid_payto_id                 String?                @db.VarChar(30)
  bid_payto_type               String?                @db.VarChar(10)
  bid_payto_name               String?                @db.VarChar(100)
  vsa_vendor_bank              String?                @db.VarChar(100)
  vsa_bank_accno               String?                @db.VarChar(25)
  bid_payto_address            String?                @db.VarChar(500)
  bid_factoring_type           String?                @db.VarChar(4)
  bid_factoring_id             String?                @db.VarChar(30)
  bid_factoring_name           String?                @db.VarChar(100)
  ...
  at_activity_code_budget      String?                @db.VarChar(20)
  bdg_budget_code              String?                @db.VarChar(10)
  crd_extended_field           Json?
  createddate                  DateTime?              @default(now()) @db.DateTime(0)
  createdby                    String?                @db.VarChar(250)
  updateddate                  DateTime?              @db.DateTime(0)
  updatedby                    String?                @db.VarChar(250)
  credit_note_ap_master        credit_note_ap_master? @relation(fields: [cna_credit_note_ap_master_id], references: [cna_credit_note_ap_master_id], onDelete: NoAction, onUpdate: NoAction, map: "FK_CreditNoteAP")
  account_main                 account_main?          @relation(fields: [acm_acct_code], references: [acm_acct_code], onDelete: Restrict, onUpdate: Restrict, map: "fk__acm_acct_code_71")

  @@index([cna_credit_note_ap_master_id], map: "FK_CreditNoteAP")
  @@index([acm_acct_code], map: "fk__acm_acct_code_71")
}

model credit_note_ap_master {
  cna_credit_note_ap_master_id Int                      @id @default(autoincrement())
  cna_crnote_no                String?                  @unique(map: "cnm_crnote_no_UNIQUE") @db.VarChar(250)
  bim_bills_no                 String?                  @db.VarChar(30)
  cna_crnote_desc              String?                  @db.VarChar(500)
  cna_crnote_date              DateTime?                @db.DateTime(0)
  cna_approve_date             DateTime?                @db.DateTime(0)
  cna_cn_total_amount          Decimal?                 @db.Decimal(15, 2)
  cna_ent_total_amount         Decimal?                 @db.Decimal(15, 4)
  cna_conversion_rate          Decimal?                 @db.Decimal(15, 4)
  cna_currency_unit            Decimal?                 @db.Decimal(10, 2)
  cna_currency_code            String?                  @db.VarChar(10)
  cna_rate_type                String?                  @db.VarChar(10)
  cna_posting_no               String?                  @db.VarChar(20)
  cna_cancel_by                String?                  @db.VarChar(45)
  cna_cancel_reason            String?                  @db.VarChar(300)
  cna_cancel_date              DateTime?                @db.DateTime(0)
  cna_extended_field           Json?
  cna_system_id                String?                  @db.VarChar(20)
  cna_status_cd                String?                  @db.VarChar(20)
  createddate                  DateTime?                @default(now()) @db.DateTime(0)
  createdby                    String?                  @db.VarChar(250)
  updateddate                  DateTime?                @db.DateTime(0)
  updatedby                    String?                  @db.VarChar(250)
  ...
  @@index([bim_bills_no], map: "ind_bim_bills_no")
}


model debit_note_ap_details {
  ded_id                      Int       @id @default(autoincrement())
  dna_debit_note_ap_master_id Int?
  bid_bills_details_id        Int?
  ded_line_no                 Int
  itm_item_code               String?   @db.VarChar(100)
  itm_item_desc               String?   @db.VarChar(200)
  ...
  oun_code                    String?   @db.VarChar(20)
  bid_amt                     Decimal?  @db.Decimal(15, 2)
  ded_cn_amt                  Decimal?  @db.Decimal(15, 2)
  ded_dn_amt                  Decimal?  @db.Decimal(15, 2)
  ded_bal_amt                 Decimal?  @db.Decimal(15, 2)
  bid_ent_amt                 Decimal?  @db.Decimal(15, 4)
  ded_cn_ent_amt              Decimal?  @db.Decimal(15, 4)
  ded_dn_ent_amt              Decimal?  @db.Decimal(15, 4)
  ded_bal_ent_amt             Decimal?  @db.Decimal(15, 4)
  ded_transaction_type        String?   @db.VarChar(20)
  ded_status                  String?   @db.VarChar(30)
  acm_acct_code               String?   @db.VarChar(10)
  fty_fund_type               String?   @db.VarChar(20)
  at_activity_code            String?   @db.VarChar(20)
  ccr_costcentre              String?   @db.VarChar(20)
  ...
  at_activity_code_budget     String?   @db.VarChar(20)
  bdg_budget_code             String?   @db.VarChar(10)
  ded_extended_field          Json?
  createddate                 DateTime? @default(now()) @db.DateTime(0)
  createdby                   String?   @db.VarChar(250)
  updateddate                 DateTime? @db.DateTime(0)
  updatedby                   String?   @db.VarChar(250)

  @@index([dna_debit_note_ap_master_id], map: "fk_dn_ap_idx")
}

model debit_note_ap_master {
  dna_debit_note_ap_master_id Int       @id @default(autoincrement())
  dna_dnnote_no               String?   @db.VarChar(20)
  bim_bills_no                String?   @db.VarChar(30)
  dna_dnnote_desc             String?   @db.VarChar(500)
  dna_dnnote_date             DateTime? @db.DateTime(0)
  dna_approve_date            DateTime? @db.DateTime(0)
  dna_dn_total_amount         Decimal?  @db.Decimal(15, 2)
  dna_ent_total_amount        Decimal?  @db.Decimal(15, 4)
  dna_conversion_rate         Decimal?  @db.Decimal(15, 4)
  dna_currency_unit           Decimal?  @db.Decimal(10, 2)
  dna_currency_code           String?   @db.VarChar(10)
  dna_rate_type               String?   @db.VarChar(10)
  dna_posting_no              String?   @db.VarChar(20)
  dna_cancel_by               String?   @db.VarChar(45)
  dna_cancel_reason           String?   @db.VarChar(300)
  dna_cancel_date             DateTime? @db.DateTime(0)
  dna_extended_field          Json?
  dna_system_id               String?   @db.VarChar(20)
  dna_status_dn               String?   @db.VarChar(20)
  createddate                 DateTime? @default(now()) @db.DateTime(0)
  createdby                   String?   @db.VarChar(250)
  updateddate                 DateTime? @db.DateTime(0)
  updatedby                   String?   @db.VarChar(250)
...
model glopening_yearly {
  gly_glopening_yearly_id Int          @id
  oun_code                String       @db.VarChar(20)
  org_code                String       @db.VarChar(20)
  gly_year                Int
  acm_acct_code           String       @db.VarChar(10)
  ...
  fty_fund_type           String       @db.VarChar(20)
  at_activity_code        String?      @db.VarChar(10)
  gly_debit_bal           Decimal?     @default(0.00) @db.Decimal(15, 2)
  gly_credit_bal          Decimal?     @default(0.00) @db.Decimal(15, 2)
  cpa_project_no          String?      @db.VarChar(30)
  gly_date                DateTime?    @db.DateTime(0)
  gly_extended_field      Json?
  createddate             DateTime?    @default(now()) @db.DateTime(0)
  createdby               String?      @db.VarChar(250)
  updateddate             DateTime?    @db.DateTime(0)
  updatedby               String?      @db.VarChar(250)
  kod_so                  String?      @db.VarChar(45)
  gly_debit_bal_1         Decimal?     @db.Decimal(15, 2)
  gly_credit_bal_1        Decimal?     @db.Decimal(15, 2)
  account_main            account_main @relation(fields: [acm_acct_code], references: [acm_acct_code], onUpdate: Restrict, map: "fk__acm_acct_code_40")

  @@unique([org_code, gly_year, oun_code, fty_fund_type, acm_acct_code, cpa_project_no, ccr_costcentre, at_activity_code, gly_debit_bal, gly_credit_bal], map: "glopening_uk1")
  @@index([acm_acct_code], map: "fk__acm_acct_code_40")
}
...
model manual_journal_details {
  mjm_journal_no          Int?
  mjd_journal_detl_id     Int                    @id
  mjd_source              String?                @db.VarChar(45)
  mjd_reference           String?                @db.VarChar(250)
  fty_fund_type           String?                @db.VarChar(20)
  ft_fund_desc            String?                @db.VarChar(250)
  at_activity_code        String?                @db.VarChar(10)
  oun_code                String?                @db.VarChar(20)
  ...
  ccr_costcentre          String?                @db.VarChar(20)
  ccr_costcentre_desc     String?                @db.VarChar(250)
  code_so                 String?                @db.VarChar(45)
  acm_acct_code           String?                @db.VarChar(10)
  acm_acct_desc           String?                @db.VarChar(500)
  budget_code             String?                @db.VarChar(45)
  fty_fund_type_budget    String?                @db.VarChar(20)
  at_activity_code_budget String?                @db.VarChar(45)
  oun_code_budget         String?                @db.VarChar(20)
  ccr_costcentre_budget   String?                @db.VarChar(45)
  sbg_budget_id           Int?
  mjd_trans_amt           Decimal?               @db.Decimal(15, 2)
  mjd_total_payment       Decimal?               @db.Decimal(15, 2)
  mjd_rounding            Decimal?               @db.Decimal(15, 2)
  mjd_trans_type          String?                @db.VarChar(2)
  mjd_document_no         String?                @db.VarChar(250)
  mjd_reference_2         String?                @db.VarChar(100)
  mjd_payto_type          String?                @db.VarChar(10)
  mjd_payto_id            String?                @db.VarChar(50)
  mjd_payto_name          String?                @db.VarChar(100)
  mjd_document_type       String?                @db.VarChar(45)
  mjd_status              String?                @db.VarChar(20)
  mjd_extended_field      Json?
  createddate             DateTime?              @default(now()) @db.DateTime(0)
  createdby               String?                @db.VarChar(250)
  updateddate             DateTime?              @db.DateTime(0)
  updatedby               String?                @db.VarChar(250)
  cpa_project_no          String?                @db.VarChar(30)
  mjd_item_lineno         Int?
  mjd_trans_date          DateTime?              @db.DateTime(0)
  mjd_taxcode             String?                @db.VarChar(10)
  mjd_taxpct              Decimal?               @db.Decimal(6, 2)
  mjd_ent_amt             Decimal?               @db.Decimal(15, 4)
  mjd_budget_type         String?                @db.VarChar(45)
  mjd_taxamt              Decimal?               @db.Decimal(15, 2)
  mjd_post_type           String?                @db.VarChar(45)
  mjd_item_code           String?                @db.VarChar(45)
  mjd_item_category       String?                @db.VarChar(45)
  mjd_advance_category    String?                @db.VarChar(20)
  mjd_sponsored_amt       Decimal?               @db.Decimal(15, 2)
  mjd_invoice_amt         Decimal?               @db.Decimal(15, 2)
  mjd_paid_amt            Decimal?               @db.Decimal(15, 2)
  mjd_source_detail_id    String?                @db.VarChar(45)
  mjd_mode                String?                @db.VarChar(45)
  mjd_deposit_no          String?                @db.VarChar(100)
  mjd_statement_date      DateTime?              @db.DateTime(0)
  mjd_int_doc_no          String?                @db.VarChar(250)
  mjd_remark1             String?                @db.VarChar(45)
  mjd_remark2             String?                @db.VarChar(200)
  cpa_project_no_old      String?                @db.VarChar(45)
  glacct_code             String?                @db.VarChar(45)
  cascading_old           String?                @db.VarChar(100)
  acm_acct_code_old       String?                @db.VarChar(10)
  bdg_budget_code_old     String?                @db.VarChar(10)
  mjd_doubtful_flag       String?                @db.VarChar(1)
  mjd_reference_source    String?                @db.VarChar(100)
  account_main            account_main?          @relation(fields: [acm_acct_code], references: [acm_acct_code], onDelete: Restrict, onUpdate: Restrict, map: "fk__acm_acct_code_47")
  manual_journal_master   manual_journal_master? @relation(fields: [mjm_journal_no], references: [mjm_journal_id], onDelete: Cascade, onUpdate: NoAction, map: "fk_mjm_journal_no")

  @@index([acm_acct_code], map: "fk__acm_acct_code_47")
  @@index([mjm_journal_no], map: "fk_reference_15")
}


model manual_journal_master {
  mjm_journal_id         Int                      @id
  mjm_journal_no         String?                  @unique(map: "mjm_journal_no_UNIQUE") @db.VarChar(50)
  mjm_journal_no_temp    String?                  @db.VarChar(100)
  mjm_journal_desc       String?                  @db.VarChar(1000)
  mjm_typeofjournal      String?                  @db.VarChar(20)
  mjm_system_id          String?                  @db.VarChar(30)
  mjm_total_amt          Decimal?                 @db.Decimal(15, 2)
  mjm_conversion_rate    Decimal?                 @db.Decimal(15, 4)
  mjm_currency_unit      Decimal?                 @db.Decimal(10, 2)
  mjm_currency_code      String?                  @db.VarChar(10)
  mjm_rate_type          String?                  @db.VarChar(10)
  mjm_ent_amt            Decimal?                 @db.Decimal(15, 4)
  mjm_staff_type         String?                  @db.VarChar(20)
  mjm_payroll_month      String?                  @db.VarChar(10)
  mjm_approvedate        DateTime?                @default(now()) @db.DateTime(0)
  mjm_approveby          String?                  @db.VarChar(250)
  mjm_canceldate         DateTime?                @db.DateTime(0)
  mjm_cancelby           String?                  @db.VarChar(250)
  mjm_cancel_reason      String?                  @db.VarChar(1000)
  mjm_enterdate          DateTime?                @db.DateTime(0)
  mjm_enterby            String?                  @db.VarChar(250)
  mjm_status             String?                  @db.VarChar(20)
  mjm_extended_field     Json?
  createddate            DateTime?                @default(now()) @db.DateTime(0)
  createdby              String?                  @db.VarChar(250)
  updateddate            DateTime?                @db.DateTime(0)
  updatedby              String?                  @db.VarChar(250)
  org_code               String                   @default("TM") @db.VarChar(20)
  pmt_posting_no         String?                  @db.VarChar(20)
  dpm_deposit_no         String?                  @db.VarChar(20)
  mjm_flag_reverse       String?                  @db.VarChar(1)
  mjm_reverse_journal_no String?                  @db.VarChar(45)
  mjm_reverse_status     String?                  @db.VarChar(20)
  mjm_cust_type          String?                  @db.VarChar(5)
  mjm_cust_id            String?                  @db.VarChar(50)
  mjm_cust_name          String?                  @db.VarChar(100)
  mjm_address_type       String?                  @db.VarChar(20)
  mjm_address_line1      String?                  @db.VarChar(500)
  mjm_address_line2      String?                  @db.VarChar(500)
  mjm_address_postcode   String?                  @db.VarChar(200)
  mjm_address_city       String?                  @db.VarChar(500)
  mjm_address_state      String?                  @db.VarChar(500)
  mjm_address_country    String?                  @db.VarChar(500)
  mjm_rounding           String?                  @db.VarChar(1)
  mjm_acct_code_adv      String?                  @db.VarChar(45)
  mjm_posting_no_cancel  String?                  @db.VarChar(50)
  mjm_journal_no_old     String?                  @db.VarChar(45)
  mjm_status_old         String?                  @db.VarChar(45)
  mjm_system_id_old      String?                  @db.VarChar(45)
  mjm_transaction_period String?                  @db.VarChar(50)
  manual_journal_details manual_journal_details[]

  @@index([mjm_cust_id], map: "IND01_CUST_ID")
  @@index([createddate], map: "IND02_CREATEDDATE")
  @@index([updateddate], map: "IND03_UPDATEDDATE")
}
