declare global {
  const __buildAssetsURL: typeof import('C:/KerisiAI/kerisi/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('C:/KerisiAI/kerisi/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const buildNuxtTemplate: typeof import('C:/KerisiAI/kerisi/server/utils/buildNuxtTemplate.js')['buildNuxtTemplate']
  const cachedEventHandler: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('C:/KerisiAI/kerisi/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getLookupData: typeof import('C:/KerisiAI/kerisi/server/utils/lookup.js')['getLookupData']
  ...
  const getRouteRules: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['nitroPlugin']
  const parseCookies: typeof import('h3')['parseCookies']
  const prisma: typeof import('C:/KerisiAI/kerisi/server/utils/prisma')['default']
  ...
  const useAppConfig: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime')['useStorage']
  const writeEarlyHints: typeof import('h3')['writeEarlyHints']
}
export { defineCachedFunction, defineCachedEventHandler, cachedFunction, cachedEventHandler, useRuntimeConfig, useStorage, useNitroApp, defineNitroPlugin, nitroPlugin, defineRenderHandler, getRouteRules, useAppConfig } from 'C:/KerisiAI/kerisi/node_modules/nitropack/dist/runtime';
...
export { buildNuxtTemplate } from '../../server/utils/buildNuxtTemplate';
export { default as prisma } from '../../server/utils/prisma';
export { getLookupData } from '../../server/utils/lookup';