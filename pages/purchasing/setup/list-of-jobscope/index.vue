...
const pageName = "List Of Jobscope";
const moduleName = "Purchasing";
const pageBreadcrumbText = "Dashboard > Purchasing > Setup > List Of Jobscope";
...
const {
  ...
  pageName: "List Of Jobscope",
  apiDataPath: "/api/purchasing/setup/list-of-jobscope",
  defaultExportColumns: ["Code", "Name", "Level", "Type", "Category", "Parent", "Status"],
  getFilteredList: () => filteredJobscopeList.value,
  datatableRef,
  searchKeyword,
  smartFilter,
  applyFilters,
